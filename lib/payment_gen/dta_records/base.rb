  ...
  module DTARecords
    class Base
      ...
      def entry_sequence_number
        @entry_sequence_number.to_s.rjust(5,'0')
      end
      ...
      def ordering_partys_address_line1(line_size = 24)
        @data[:ordering_partys_address_line1].to_s[0, line_size].ljust(line_size)
      end

      def ordering_partys_address_line2(line_size = 24)
        @data[:ordering_partys_address_line2].to_s[0, line_size].ljust(line_size)
      end

      def ordering_partys_address_line3(line_size = 24)
        @data[:ordering_partys_address_line3].to_s[0, line_size].ljust(line_size)
      end

      def ordering_partys_address_line4(line_size = 24)
        @data[:ordering_partys_address_line4].to_s[0, line_size].ljust(line_size)
      end
