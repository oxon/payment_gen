...
describe PaymentGen::EZAGRecords::DomesticReferenceNumberRecord do
  ...
  describe "to_s" do
    it "returns the domestic post account record" do
      ...
      record.to_s.should == ("03628092400000148387493248387493201280000010000000CHF0000000080350 CHFCH  95847392999999999999999999999999999P Spöri Enterprises                  z.H. Fritz Knall                   Packweg 9                          1843      Genf                                                                                                                                                                            V-2011.8796 CD Uster ZH            Konto 61160 Fr. 104.00             Konto 60060 Fr. 104.00             Konto 68000 Fr. 117.00                                                                                                                                                                           ")
    end
  end
end
