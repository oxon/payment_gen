...
describe PaymentGen::EZAGRecords::DomesticPostAccountRecord do
  ...
  describe "to_s" do
    it "returns the domestic post account record" do
      ...
      record.to_s.should == '03628092400000148387493248387493201220000010000000CHF0000000080350 CHFCH958473929      CH8794857239482758715              Spöri Enterprises                  z.H. Fritz Knall                   Packweg 9                          1843      Genf                     '.ljust(700, ' ')
    end
  end
