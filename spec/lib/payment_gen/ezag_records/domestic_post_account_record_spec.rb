...
describe PaymentGen::EZAGRecords::DomesticPostAccountRecord do
  ...
  describe "to_s" do
    it "returns the domestic post account record" do
      ...
      record.to_s.should == ('03628092400000148387493248387493201220000010000000CHF0000000080350 CHFCH958473929      CH8794857239482758715              Spöri Enterprises                  z.H. Fritz Knall                   Packweg 9                          1843      Genf                     '.ljust(402, ' ') + 'V-2011.8796 CD Uster ZH            Konto 61160 Fr. 104.00             Konto 60060 Fr. 104.00             Konto 68000 Fr. 117.00             ').ljust(700, ' ')
    end
  end
