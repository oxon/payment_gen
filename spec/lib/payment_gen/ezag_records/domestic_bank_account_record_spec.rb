...
describe PaymentGen::EZAGRecords::DomesticBankAccountRecord do
  ...
  describe "to_s" do
    it "returns the domestic post account record" do
      ...
      record.to_s.should == '03628092400000148387493248387493201270000010000000CHF0000000080350 CHFCH838938235      CH8794857239482758715              UBS AG                             c/o Petra Huber                                                       8010      Zürich                   Spöri Enterprises                  z.H. Fritz Knall                   Packweg 9                          1843      Genf                     '.ljust(700, ' ')
    end
  end
