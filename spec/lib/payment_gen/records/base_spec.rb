...
describe PaymentGen::Records::Base do
  ...
  describe "it uses a minimal character set" do
    subject { PaymentGen::Records::Base.new(:data_file_sender_identification => 'ÄöÜ') }
    ...
    it "only works with strings internally" do
      record = PaymentGen::Records::Base.new(:payment_amount => 12.5)
  ...
  describe "beneficiary_address" do
    it "trims beneficiary_address_line1, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:beneficiary_address_line1 => too_long_text)
    ...
    it "trims beneficiary_address_line2, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:beneficiary_address_line2 => too_long_text)
    ...
    it "trims beneficiary_address_line3, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:beneficiary_address_line3 => too_long_text)
    ...
    it "trims beneficiary_address_line4, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:beneficiary_address_line4 => too_long_text)
  ...
  describe "ordering_partys_address" do
    it "trims ordering_partys_address_line1, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:ordering_partys_address_line1 => too_long_text)
    ...
    it "trims ordering_partys_address_line2, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:ordering_partys_address_line2 => too_long_text)
    ...
    it "trims ordering_partys_address_line3, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:ordering_partys_address_line3 => too_long_text)
    ...
    it "trims ordering_partys_address_line4, when it exceedes the maximum length" do
      record = PaymentGen::Records::Base.new(:ordering_partys_address_line4 => too_long_text)
